        ...
        switch (msg.type) {
            ...
            case 'done': {
                ...
                state.curData = {
                    ...
                    numSuperPlates: msg.numSuperPlates,
                    superPlateVec: msg.superPlateVec,
                    superPlateIsOcean: new Set(msg.superPlateIsOcean || []),
                    superPlateDensity: msg.superPlateDensity,
